...
// mustEmbedUnimplementedRpcFileServer provides a mock function for the type MockUnsafeRpcFileServer
func (_mock *MockUnsafeRpcFileServer) mustEmbedUnimplementedRpcFileServer() {
	_mock.Called()
	return
}
