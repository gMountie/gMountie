...
// Allocate provides a mock function for the type MockFile
func (_mock *MockFile) Allocate(off uint64, size uint64, mode uint32) fuse.Status {
	ret := _mock.Called(off, size, mode)
	...
	var r0 fuse.Status
	if returnFunc, ok := ret.Get(0).(func(uint64, uint64, uint32) fuse.Status); ok {
		r0 = returnFunc(off, size, mode)
	} else {
...
func (_c *MockFile_Allocate_Call) RunAndReturn(run func(off uint64, size uint64, mode uint32) fuse.Status) *MockFile_Allocate_Call {
	_c.Call.Return(run)
	return _c
}

// Chmod provides a mock function for the type MockFile
func (_mock *MockFile) Chmod(perms uint32) fuse.Status {
	ret := _mock.Called(perms)
	...
	var r0 fuse.Status
	if returnFunc, ok := ret.Get(0).(func(uint32) fuse.Status); ok {
		r0 = returnFunc(perms)
	} else {
		r0 = ret.Get(0).(fuse.Status)
	}
...
func (_c *MockFile_Chmod_Call) Return(status fuse.Status) *MockFile_Chmod_Call {
	_c.Call.Return(status)
	return _c
}

func (_c *MockFile_Chmod_Call) RunAndReturn(run func(perms uint32) fuse.Status) *MockFile_Chmod_Call {
	_c.Call.Return(run)
	return _c
}

// Chown provides a mock function for the type MockFile
func (_mock *MockFile) Chown(uid uint32, gid uint32) fuse.Status {
	ret := _mock.Called(uid, gid)
	...
	var r0 fuse.Status
	if returnFunc, ok := ret.Get(0).(func(uint32, uint32) fuse.Status); ok {
		r0 = returnFunc(uid, gid)
	} else {
		r0 = ret.Get(0).(fuse.Status)
	}
	return r0
...
func (_c *MockFile_Chown_Call) Return(status fuse.Status) *MockFile_Chown_Call {
	_c.Call.Return(status)
	return _c
}

func (_c *MockFile_Chown_Call) RunAndReturn(run func(uid uint32, gid uint32) fuse.Status) *MockFile_Chown_Call {
	_c.Call.Return(run)
	return _c
}

// Flush provides a mock function for the type MockFile
func (_mock *MockFile) Flush() fuse.Status {
	ret := _mock.Called()
	...
	var r0 fuse.Status
	if returnFunc, ok := ret.Get(0).(func() fuse.Status); ok {
		r0 = returnFunc()
	} else {
		r0 = ret.Get(0).(fuse.Status)
	}
...
func (_c *MockFile_Flush_Call) Return(status fuse.Status) *MockFile_Flush_Call {
	_c.Call.Return(status)
	return _c
}
...
// Fsync provides a mock function for the type MockFile
func (_mock *MockFile) Fsync(flags int) fuse.Status {
	...
	var r0 fuse.Status
	if returnFunc, ok := ret.Get(0).(func(int) fuse.Status); ok {
		r0 = returnFunc(flags)
	} else {
		r0 = ret.Get(0).(fuse.Status)
	}
...
func (_c *MockFile_Fsync_Call) RunAndReturn(run func(flags int) fuse.Status) *MockFile_Fsync_Call {
	_c.Call.Return(run)
	return _c
}

// GetAttr provides a mock function for the type MockFile
func (_mock *MockFile) GetAttr(out *fuse.Attr) fuse.Status {
	...
	var r0 fuse.Status
	if returnFunc, ok := ret.Get(0).(func(*fuse.Attr) fuse.Status); ok {
		r0 = returnFunc(out)
	} else {
		r0 = ret.Get(0).(fuse.Status)
	}
...
func (_c *MockFile_GetAttr_Call) Return(status fuse.Status) *MockFile_GetAttr_Call {
	_c.Call.Return(status)
	return _c
}

func (_c *MockFile_GetAttr_Call) RunAndReturn(run func(out *fuse.Attr) fuse.Status) *MockFile_GetAttr_Call {
	_c.Call.Return(run)
	return _c
}

// GetLk provides a mock function for the type MockFile
func (_mock *MockFile) GetLk(owner uint64, lk *fuse.FileLock, flags uint32, out *fuse.FileLock) fuse.Status {
	ret := _mock.Called(owner, lk, flags, out)
	...
	var r0 fuse.Status
	if returnFunc, ok := ret.Get(0).(func(uint64, *fuse.FileLock, uint32, *fuse.FileLock) fuse.Status); ok {
		r0 = returnFunc(owner, lk, flags, out)
	} else {
		r0 = ret.Get(0).(fuse.Status)
	}
	return r0
...
func (_c *MockFile_GetLk_Call) Run(run func(owner uint64, lk *fuse.FileLock, flags uint32, out *fuse.FileLock)) *MockFile_GetLk_Call {
	_c.Call.Run(func(args mock.Arguments) {
		...
		var arg1 *fuse.FileLock
		if args[1] != nil {
			arg1 = args[1].(*fuse.FileLock)
		}
		var arg2 uint32
		if args[2] != nil {
			arg2 = args[2].(uint32)
...
func (_c *MockFile_GetLk_Call) RunAndReturn(run func(owner uint64, lk *fuse.FileLock, flags uint32, out *fuse.FileLock) fuse.Status) *MockFile_GetLk_Call {
	_c.Call.Return(run)
	return _c
}

// InnerFile provides a mock function for the type MockFile
func (_mock *MockFile) InnerFile() nodefs.File {
	ret := _mock.Called()
	...
	var r0 nodefs.File
	if returnFunc, ok := ret.Get(0).(func() nodefs.File); ok {
		r0 = returnFunc()
	} else {
		if ret.Get(0) != nil {
...
func (_c *MockFile_InnerFile_Call) Return(file nodefs.File) *MockFile_InnerFile_Call {
	_c.Call.Return(file)
	return _c
}
...
func (_mock *MockFile) Read(dest []byte, off int64) (fuse.ReadResult, fuse.Status) {
	ret := _mock.Called(dest, off)
	...
	var r1 fuse.Status
	if returnFunc, ok := ret.Get(0).(func([]byte, int64) (fuse.ReadResult, fuse.Status)); ok {
		return returnFunc(dest, off)
	}
	if returnFunc, ok := ret.Get(0).(func([]byte, int64) fuse.ReadResult); ok {
		r0 = returnFunc(dest, off)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(fuse.ReadResult)
		}
	}
	if returnFunc, ok := ret.Get(1).(func([]byte, int64) fuse.Status); ok {
		r1 = returnFunc(dest, off)
	} else {
...
func (_c *MockFile_Read_Call) Return(readResult fuse.ReadResult, status fuse.Status) *MockFile_Read_Call {
	_c.Call.Return(readResult, status)
	return _c
}

func (_c *MockFile_Read_Call) RunAndReturn(run func(dest []byte, off int64) (fuse.ReadResult, fuse.Status)) *MockFile_Read_Call {
	_c.Call.Return(run)
	return _c
}

// Release provides a mock function for the type MockFile
func (_mock *MockFile) Release() {
	_mock.Called()
	return
}
...
// SetInode provides a mock function for the type MockFile
func (_mock *MockFile) SetInode(inode *nodefs.Inode) {
	_mock.Called(inode)
	return
}
...
//   - inode *nodefs.Inode
func (_e *MockFile_Expecter) SetInode(inode interface{}) *MockFile_SetInode_Call {
	return &MockFile_SetInode_Call{Call: _e.mock.On("SetInode", inode)}
}

func (_c *MockFile_SetInode_Call) Run(run func(inode *nodefs.Inode)) *MockFile_SetInode_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 *nodefs.Inode
		if args[0] != nil {
			arg0 = args[0].(*nodefs.Inode)
		}
		run(
			arg0,
		)
...
func (_c *MockFile_SetInode_Call) RunAndReturn(run func(inode *nodefs.Inode)) *MockFile_SetInode_Call {
	_c.Run(run)
	return _c
}

// SetLk provides a mock function for the type MockFile
func (_mock *MockFile) SetLk(owner uint64, lk *fuse.FileLock, flags uint32) fuse.Status {
	ret := _mock.Called(owner, lk, flags)
	...
	var r0 fuse.Status
	if returnFunc, ok := ret.Get(0).(func(uint64, *fuse.FileLock, uint32) fuse.Status); ok {
		r0 = returnFunc(owner, lk, flags)
	} else {
		r0 = ret.Get(0).(fuse.Status)
	}
	return r0
...
func (_c *MockFile_SetLk_Call) RunAndReturn(run func(owner uint64, lk *fuse.FileLock, flags uint32) fuse.Status) *MockFile_SetLk_Call {
	_c.Call.Return(run)
	return _c
}

// SetLkw provides a mock function for the type MockFile
func (_mock *MockFile) SetLkw(owner uint64, lk *fuse.FileLock, flags uint32) fuse.Status {
	ret := _mock.Called(owner, lk, flags)
...
func (_c *MockFile_SetLkw_Call) RunAndReturn(run func(owner uint64, lk *fuse.FileLock, flags uint32) fuse.Status) *MockFile_SetLkw_Call {
	_c.Call.Return(run)
	return _c
}

// String provides a mock function for the type MockFile
func (_mock *MockFile) String() string {
	ret := _mock.Called()
...
func (_c *MockFile_String_Call) Return(s string) *MockFile_String_Call {
	_c.Call.Return(s)
	return _c
}
...
func (_mock *MockFile) Truncate(size uint64) fuse.Status {
	...
	var r0 fuse.Status
	if returnFunc, ok := ret.Get(0).(func(uint64) fuse.Status); ok {
		r0 = returnFunc(size)
	} else {
		r0 = ret.Get(0).(fuse.Status)
	}
...
func (_c *MockFile_Truncate_Call) Return(status fuse.Status) *MockFile_Truncate_Call {
	_c.Call.Return(status)
	return _c
}

func (_c *MockFile_Truncate_Call) RunAndReturn(run func(size uint64) fuse.Status) *MockFile_Truncate_Call {
	_c.Call.Return(run)
	return _c
}

// Utimens provides a mock function for the type MockFile
func (_mock *MockFile) Utimens(atime *time.Time, mtime *time.Time) fuse.Status {
	ret := _mock.Called(atime, mtime)
	...
	var r0 fuse.Status
	if returnFunc, ok := ret.Get(0).(func(*time.Time, *time.Time) fuse.Status); ok {
		r0 = returnFunc(atime, mtime)
	} else {
		r0 = ret.Get(0).(fuse.Status)
	}
	return r0
...
func (_c *MockFile_Utimens_Call) Return(status fuse.Status) *MockFile_Utimens_Call {
	_c.Call.Return(status)
	return _c
}

func (_c *MockFile_Utimens_Call) RunAndReturn(run func(atime *time.Time, mtime *time.Time) fuse.Status) *MockFile_Utimens_Call {
	_c.Call.Return(run)
	return _c
}

// Write provides a mock function for the type MockFile
func (_mock *MockFile) Write(data []byte, off int64) (uint32, fuse.Status) {
	ret := _mock.Called(data, off)
	...
	var r0 uint32
	var r1 fuse.Status
	if returnFunc, ok := ret.Get(0).(func([]byte, int64) (uint32, fuse.Status)); ok {
		return returnFunc(data, off)
	}
	if returnFunc, ok := ret.Get(0).(func([]byte, int64) uint32); ok {
		r0 = returnFunc(data, off)
	} else {
		r0 = ret.Get(0).(uint32)
	}
	if returnFunc, ok := ret.Get(1).(func([]byte, int64) fuse.Status); ok {
		r1 = returnFunc(data, off)
	} else {
		r1 = ret.Get(1).(fuse.Status)
	}
	return r0, r1
...
func (_c *MockFile_Write_Call) RunAndReturn(run func(data []byte, off int64) (uint32, fuse.Status)) *MockFile_Write_Call {
	_c.Call.Return(run)
	return _c
}
