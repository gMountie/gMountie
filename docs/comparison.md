...
| ------------------------------ | ------------------------------------------------ | ------------------------------------------- | -------------------------------------- | ------------------------------------- | -------------------------------- |
| **Protocol**                   | gRPC over HTTP/2 (opt-in Snappy compression)     | NFSv4 over TCP, inside a VPN tunnel         | SFTP over SSH                          | WebDAV inside WireGuard               | HTTP to S3 / S3-compatible API   |
