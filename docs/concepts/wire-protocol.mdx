...
A `cat /mnt/shared/big.bin` from a cold cache. With the [cache](./cache.mdx) on, repeat reads of the same chunks skip everything between Lookup and Release.
