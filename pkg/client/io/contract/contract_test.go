...
func (s *ContractSuite) TestMemfs() {
	contract.RunBackendContract(s.T(), "memfs", func() cio.FileSystemBackend {
		return memfs.New()
	})
}
...
func (s *ContractSuite) TestObserverOverMemfs() {
	contract.RunBackendContract(s.T(), "observer-over-memfs", func() cio.FileSystemBackend {
...
func (s *ContractSuite) TestCacheOverMemfs() {
	contract.RunBackendContract(s.T(), "cache-over-memfs", func() cio.FileSystemBackend {
...
func (s *ContractSuite) TestIdentityOverMemfs() {
	contract.RunBackendContract(s.T(), "identity-over-memfs", func() cio.FileSystemBackend {
		...
		rw := cio.NewIDRewriter(
			&cio.Identity{Uid: serverUID, Gid: serverGID, Gids: []uint32{serverGID}},
