...
// NOTE: the macOS↔Linux SETXATTR *flag* translation lives in the OS-neutral
// wire layer (proto.XAttrCreateMode + pkg/common/fsconv), not here — only the
// xattr *name* remap (a Linux-storage namespace concern) is darwin-specific.
