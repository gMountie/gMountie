...
const (
	VolumeService_List_FullMethodName    = "/gmountie.VolumeService/List"
	VolumeService_Resolve_FullMethodName = "/gmountie.VolumeService/Resolve"
)
...
type VolumeServiceClient interface {
	...
	Resolve(ctx context.Context, in *VolumeResolveRequest, opts ...grpc.CallOption) (*VolumeResolveReply, error)
}
...
func (c *volumeServiceClient) Resolve(ctx context.Context, in *VolumeResolveRequest, opts ...grpc.CallOption) (*VolumeResolveReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(VolumeResolveReply)
	err := c.cc.Invoke(ctx, VolumeService_Resolve_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type VolumeServiceServer interface {
	...
	Resolve(context.Context, *VolumeResolveRequest) (*VolumeResolveReply, error)
...
func (UnimplementedVolumeServiceServer) Resolve(context.Context, *VolumeResolveRequest) (*VolumeResolveReply, error) {
...
func _VolumeService_Resolve_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(VolumeResolveRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(VolumeServiceServer).Resolve(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: VolumeService_Resolve_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(VolumeServiceServer).Resolve(ctx, req.(*VolumeResolveRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var VolumeService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Resolve",
			Handler:    _VolumeService_Resolve_Handler,
		},
	},
