...
const (
	VersionService_Get_FullMethodName = "/gmountie.VersionService/Get"
)
...
type VersionServiceClient interface {
	Get(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionReply, error)
}
...
func (c *versionServiceClient) Get(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*VersionReply, error) {
...
type VersionServiceServer interface {
	Get(context.Context, *VersionRequest) (*VersionReply, error)
...
func (UnimplementedVersionServiceServer) Get(context.Context, *VersionRequest) (*VersionReply, error) {
...
var VersionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "gmountie.VersionService",
	...
	Metadata: "api/proto/version.proto",
}
